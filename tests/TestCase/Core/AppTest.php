 ...
 */
	public function classnameProvider() {
		return [
			...
			['Command', 'Console/Command/Task', 'Task', false, 'Cake\Shell\Task\CommandTask'],
			['Upgrade/Locations', 'Console/Command/Task', 'Task', false, 'Cake\Shell\Task\Upgrade\LocationsTask'],
